...
@section('content')
    <div class="widget">
        ...
        <div class="widget-body">
            <div class="btn-group">
                <a href="/party_peace" class="btn btn-default btn-add">
            ...
            <form id="population_info" class="form-horizontal" style="padding:20px;">
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input value="{{ $peace_info->name or null }}" maxlength="50" type="text" placeholder="请输入名称" name="name" class="form-control" id="name"/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input value="{{ $peace_info->url or null }}" maxlength="80" type="text" placeholder="请输入地址地址" name="url" class="form-control" id="url"/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input value="{{ $peace_info->longitude or null }}" maxlength="18" type="text" placeholder="请输入经度" name="longitude" class="form-control" id="longitude"/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input value="{{ $peace_info->latitude or null }}" maxlength="18" type="text" placeholder="请输入经度" name="latitude" class="form-control" id="latitude"/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input value="{{ $peace_info->last_view_time or null }}" maxlength="20" type="text" placeholder="最后查看时间" name="last_view_time" class="form-control" id="last_view_time"/>
                        </div>
                ...
                <div class="row" style="margin-top:50px;">
                    <div class="col-md-1 col-md-offset-5">
                        <button class="btn btn-primary btn-lg" type="{{ $type or 'add' }}" peace_id="{{ $peace_info->id or 0 }}" id="peace_set" type="button">
...
@section('footer')
    <script>
        $(function(){
            var obj = $("#peace_set").attr('peace_id');
            var type = $("#peace_set").attr('type');
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.code==0) {
                            ...
                            setTimeout(function(){
                                window.location.href="/party_peace";
                            },1000)
                        }else{
                            //Notify(data.msg, 'top-right', '3000', "danger", 'fa-edit');
                            $("#peace_set").attr('disabled',false);
                        }
                    }
                });
            })
