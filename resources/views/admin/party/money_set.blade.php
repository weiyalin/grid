...
@section('content')
    <div class="widget">
        ...
        <div class="widget-body">
            <div class="btn-group">
                <a href="/party_money" class="btn btn-default btn-add">
            ...
            <form id="population_info" class="form-horizontal" style="padding:20px;">
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input value="{{ $money_info->title or null }}" maxlength="50" type="text" placeholder="请输入标题" name="title" class="form-control" id="title"/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input value="{{ $money_info->manager or null }}" maxlength="20" type="text" placeholder="负责人" name="manager" class="form-control" id="manager"/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input value="{{ $money_info->manager_phone or null }}" maxlength="20" type="text" placeholder="负责人联系方式" name="manager_phone" class="form-control" id="manager_phone"/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea style="height: 160px;" class="form-control" id="content" name="content">{{ $money_info->content or null }}</textarea>
                        </div>
                ...
                <div class="row" style="margin-top:50px;">
                    <div class="col-md-1 col-md-offset-5">
                        <button class="btn btn-primary btn-lg" type="{{ $type or 'add' }}" money_id="{{ $money_info->id or 0 }}" id="money_set" type="button">
...
@section('footer')
    <script>
        $(function(){
            var obj = $("#money_set").attr('money_id');
            var type = $("#money_set").attr('type');
            if(obj!=0&&type=='see'){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.code==0) {
                            ...
                            setTimeout(function(){
                                window.location.href="/party_money";
                            },1000)
                        }else{
                            Notify(data.msg, 'top-right', '3000', "danger", 'fa-edit');
                            $("#money_set").attr('disabled',false);
                        }
                    }
                });
            })
