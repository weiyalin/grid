    ...
    <div class="widget">
        ...
        <div class="widget-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input id="manager_mobile" type='text' maxlength="20" class="form-control" name="manager_mobile"/>
                                            </div>
                                        </td>
                                        <td>
            ...
            <div class="btn-group pull-left" style="z-index:999;">
                <a href="/gps_grid_org_set" class="btn btn-default" id="btn_add" type="button">
            ...
            resultDataTable = $searchResult.dataTable({
                ...
                "fnServerData": function (sSource, aoData, fnCallback) {
                    ...
                    if(isAdvanceSearch){    //是否是高级搜索
                        ...
                        aoData['manager_mobile'] = $.trim($('#manager_mobile').val());
                ...
                "fnRowCallback": function (nRow, aData, iDisplayIndex) {
                    ...
                    if ($(nRow).find(".btn-info").length == 0) {
                        var buttonsHtml =        //按钮的html拼接
                                ...
                                "<a class='btn btn-warning btn-xs info_edit' href='/gps_grid_org_set?org_id="+aData.id+ "'><i class='fa fa-edit'></i>编辑</a>&nbsp;"+
