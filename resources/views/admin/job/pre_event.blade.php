        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <textarea name='memo' required rows="5" placeholder="请输入退回原因 -- 事件将退回到研判中心" class="form-control event_result"></textarea>
                </div>
            </div>
        </div>
    </div>
...
@section('footer')
    ...
    <script src="ui_resource/js/pre_event.js"></script>
@endsection