    ...
    <div class="widget">
        ...
        <div class="widget-body">
            ...
            <div class="btn-group pull-left" style="z-index:999;">
                <a href="/help_back_set" class="btn btn-default" id="btn_add" type="button">
                ...
                "fnRowCallback": function (nRow, aData, iDisplayIndex) {
                    ...
                    if ($(nRow).find(".btn-info").length == 0) {
                        var buttonsHtml =        //按钮的html拼接
                            "" +
                            "<a class='btn btn-info btn-xs info_detail' href='/help_back_set?type=see&feedback_id="+aData.id+ "'><i class='fa fa-list'></i>详情</a>&nbsp;" +
                            "<a class='btn btn-warning btn-xs info_edit' href='/help_back_set?type=edit&feedback_id="+aData.id+ "'><i class='fa fa-edit'></i>编辑</a>&nbsp;"+
