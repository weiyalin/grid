    ...
    <div class="widget">
        ...
        <div class="widget-body">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input id="contact_address" type='text' maxlength="255" class="form-control" name="contact_address"/>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input id="contact_phone" type='text' maxlength="20" class="form-control" name="contact_phone"/>
                                            </div>
                                        </td>
                                        <td>
            ...
            <div class="btn-group pull-left" style="z-index:999;">
                <a href="/gps_population_set" class="btn btn-default" id="btn_add" type="button">
    ...
    <script>
        ...
        function GetData(isAdvanceSearch) {
            ...
            resultDataTable = $searchResult.dataTable({
                ...
                'bStateSave': true,
                "bServerSide": true,
                "sAjaxSource": '/gps_population_data',
                "language": {
                    "sProcessing": "正在加载数据...",
                ...
                "fnServerData": function (sSource, aoData, fnCallback) {
                    ...
                    if(isAdvanceSearch){    //是否是高级搜索
                        aoData['contact_address'] = $.trim($('#contact_address').val());
                        aoData['contact_phone'] = $.trim($('#contact_phone').val());
                ...
                "fnInitComplete": function () {
                    $("input[type=search]").attr("placeholder", "输入人员名称");
                },
                "fnRowCallback": function (nRow, aData, iDisplayIndex) {
                    ...
                    if ($(nRow).find(".btn-info").length == 0) {
                        var buttonsHtml =        //按钮的html拼接
                                ...
                                "<a class='btn btn-warning btn-xs info_edit' href='/gps_population_set?person_id="+aData.id+ "'><i class='fa fa-edit'></i>编辑</a>&nbsp;"+
