    ...
    <div class="widget">
        ...
        <div class="widget-body">
            <div class="btn-group pull-left" style="z-index:999;">
                <a href="/party_twins_set" class="btn btn-default" id="btn_add" type="button">
                ...
                "fnRowCallback": function (nRow, aData, iDisplayIndex) {
                    ...
                    if ($(nRow).find(".btn-info").length == 0) {
                        var buttonsHtml =        //按钮的html拼接
                                "" +
                                "<a class='btn btn-info btn-xs info_detail' href='/party_twins_set?type=see&twins_id="+aData.id+ "'><i class='fa fa-list'></i>详情</a>&nbsp;" +
                                "<a class='btn btn-warning btn-xs info_edit' href='/party_twins_set?type=edit&twins_id="+aData.id+ "'><i class='fa fa-edit'></i>编辑</a>&nbsp;"+
                                "<a class='twins_delete btn btn-danger btn-xs' v='" + aData.id +"'><i class='fa fa-trash-o'></i> 删除 </a>";
                        $(nRow).find("td:last").html(buttonsHtml);
                    }
                    return nRow;
                }
            });
            $(document).on('click','.twins_delete',function(){
                var obj = $(this).attr('v');
                bootbox.confirm({
                    buttons: {
                        confirm: {
